...
<body>
	...
	<table width=70% hight=30%  align="center" bgcolor="#1E90FF">
		<tr>
			...
			<td align="center"><a href="index.php"><font color="#FFFFFF">ВЫЙТИ ИЗ ЛИЧНОГО КАБИНЕТА</font></a></td>
	...
	<table width=70% hight=30% align="center" border=1 bgcolor="grey">
		<tr>
			<td>
				<img src="images/whey-pro4.jpg"  align="right" width="300" height="180" alt="Протеин SuperSet Whey Pro"> <br>
...
кобальта сульфат, марганца сульфат, цинка сульфат, магния фосфат, магния гидрокарбонат, кальция стеарат), Guar Gum и натуральный или искусственный ароматизатор.	<br>			
			</td>
			<td>
