...
(function(a, b) {
    ...
    a.extend(a.ui, {
        ...
        var e = d === "Width" ? ["Left", "IsRight"] : ["Top", "Bottom"],
            f = d.toLowerCase(),
            g = {
    ...
    a.widget("ui.resizable", a.ui.mouse, {
            ...
            this._renderAxis = function(b) {
                ...
                for (var c in this.handles) {
                    ...
                    if (this.elementIsWrapper && this.originalElement[0].nodeName.match(/textarea|input|select|button/i)) {
                        ...
                        var f = ["padding", /ne|nw|n/.test(c) ? "Top" : /se|sw|s/.test(c) ? "Bottom" : /^e$/.test(c) ? "IsRight" : "Left"].join("");
        ...
        start: function(b, d) {
            ...
            if (/document/.test(h) || h == document) e.containerOffset = {
                ...
                var j = a(i),
                    k = [];
                a(["Top", "IsRight", "Left", "Bottom"]).each(function(a, b) {
