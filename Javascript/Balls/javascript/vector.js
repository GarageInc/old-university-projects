/*#######################################################
 # Простой 2D-векторный класс со своими функциями #
 #######################################################*/
var vector = (
	function () {
        ...
        //getters and setters для получения и установления значения
        ...
        // векторные функции сложения и вычитания, умножения и деления
