...
public:
    ...
    //mpreal& operator=(const mpfr::mpreal v);
...
/*
inline mpreal::mpreal(const mpfr::mpreal u)
{
...
/*
inline mpreal& mpreal::operator=(mpreal v)
{
    mpfr_set_f(mpfr_ptr(), v.mpfr_srcptr, mpreal::get_default_rnd());
...
/*
inline mpreal& mpreal::operator+=(const mpfr::mpreal u)
{
    *this = (*this) + mpreal(u);
    MPREAL_MSVC_DEBUGVIEW_CODE;
    return *this;
